        ...
        <div class="manager">
            <div class="grid wide">
                <div class="manager-form">
                    <a href="index.php" class="manager-logo">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8EuOfHcq57RgFcDPokxWfvhe7WFwo1tBWNQ&s" alt="ảnh" class="manager-logo__img">
                    </a>
